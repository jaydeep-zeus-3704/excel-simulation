        ...
        if (selectedCell.length >= 4) {
            ...
            if (!selectedCell.includes(-1)) {
                ...
                if (c1 === -1 && r1 !== -1) {
                    ...
                    const numbers = this.parseCells(r1, r1, 0, TOTAL_COLS - 1);
                    this.summary.displaySummary(numbers);
                }
                else if (c1 !== -1 && r1 === -1) {
                    ...
                    const numbers = this.parseCells(0, TOTAL_ROWS - 1, c1, c1);
                    this.summary.displaySummary(numbers);
                }
            }
        }
